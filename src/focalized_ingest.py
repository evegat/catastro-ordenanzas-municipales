...
logger = logging.getLogger('FocalizedIngest')
...
def main():
    ...
    items_to_fetch = [
        ("Punta Arenas", "12", "https://puntaarenas.cl/archivos/Direcciones/dom/PRC_PUNTA_ARENAS_2016.pdf", "https://puntaarenas.cl/normativas/", "Ordenanza Local Plan Regulador Comunal de Punta Arenas"),
    ]

    added = 0
    for com, reg, url, src, title in items_to_fetch:
    ...
    logger.info(f"Nuevos registros agregados: {added}")
